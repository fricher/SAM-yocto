...
IMAGE_TYPEDEP_samsd = "${SDIMG_ROOTFS_TYPE}"
...
do_image_samsd[recrdeps] = "do_build"

# SD card image name
SDIMG = "${IMGDEPLOYDIR}/${IMAGE_NAME}-${DISTRO_VERSION}.rpi-sdimg"
